...
$query=mysql_query("SELECT * FROM usuario,usuario_tiene_rol,rol WHERE usuario.id=$_REQUEST[id] AND usuario_tiene_rol.usuario_id=usuario.id AND usuario_tiene_rol.rol_id=rol.id");
$get=mysql_fetch_array($query);

echo "<h2>Estás viendo el usuario $get[1]</h2>";

echo "Nombre: $get[3]"."<br/>"."<br/>";
echo "Apellidos: $get[4]"."<br/>"."<br/>";
echo "Fecha de Nacimiento: $get[5]"."<br/>"."<br/>";
echo "Nacionalidad: $get[6]"."<br/>"."<br/>";
echo "E-mail: $get[7]"."<br/>"."<br/>";
echo "URL, blog: $get[8]"."<br/>"."<br/>";
echo "Sobre mi: $get[9]"."<br/>"."<br/>";
echo "Rol actual: $get[18]"."<br/>"."$get[19]"."<br/>"."<br/>";
echo "Alta en:\n".substr($get[16],8,2)."-".substr($get[16],5,2)."-".substr($get[16],0,4)."<br/>"."<br/>";
