...
echo "<h1>Registro</h1>";
echo "<form action='registrando.php' method='post'>
			<p>Escoja un apodo:</p><input type='text' name='nick'>
			<p>Una contraseña:</p><input type='password' name='passwd'>
			<!-- <input type='file' name='archivo'/> -->
			<br/>
			<p>Nombre:</p><input type='text' name='nombre'>
			<p>Apellidos:</p><input type='text' name='apellidos'>
			<p>Fecha de Nacimiento:</p><input type='text' name='fecha_nac' id='datepicker'>
			...
			<p>Sobre mi:</p><textarea name='sobre'></textarea>
			<p>Selecciona el rol que tendrá el usuario:</p>";
			
echo "<select name='rol'>";
			
			while($option=mysql_fetch_array($registros)){
			echo "<option name='rol' value='$option[0]'>$option[1]</option>";
		}
echo "</select>	
