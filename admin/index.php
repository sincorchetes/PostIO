...
tinymce.init({
 ...
 $x=mysql_query("SELECT * FROM blog;");
 $blog=mysql_fetch_array($x);

 echo "<title>$blog[1]</title>";
 echo "<h1>Editando $blog[1]</h1>";
 
 echo "<form action='aplicando.php' method='post'>";
 
 echo "<p>Título: <br/><input type='text' name='titulo' value='$blog[1]'></p>";
 echo "<p>Descripción: <br/><br/><textarea name='descripcion'>$blog[2]</textarea></p>";
 echo "<p>Palabras clave:<br/><input type='text' name='palabra_clave' value='$blog[3]'></p>";
 echo "<p>Enlaces de interés:<br/><br/><textarea name='enlace'>$blog[4]</textarea></p>";
