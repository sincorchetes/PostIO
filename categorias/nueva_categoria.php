...
echo "<h1>Nueva categoría</h1>";

echo "<form action='alta_categoria.php' method='post'>
			<p>Nombre:</p><input type='text' name='nombre'>
			<p>Descripción</p><textarea name='descripcion'></textarea>
			<input type='hidden' name='estado' value='Activada'><br/>
