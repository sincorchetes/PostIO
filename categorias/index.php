...
$registros=mysql_query("SELECT * FROM categoria;");
...
echo "<table border='0'>
			<tr>
				...
				<td>Fecha desactivación</td>
				<td>Modificar</td>
				<td>Alta</td>
				<td>Baja</td>
			</tr>";
		
while($categoria=mysql_fetch_array($registros))
{
	echo "<tr>
				<td>$categoria[1]</td>
				<td>$categoria[2]</td>
				<td>$categoria[3]</td>
				<td>".substr($categoria[4],11,8)."<br/>".substr($categoria[4],8,2)."-".substr($categoria[4],5,2)."-".substr($categoria[4],0,4)."</td>
				<td>".substr($categoria[6],11,8)."<br/>".substr($categoria[6],8,2)."-".substr($categoria[6],5,2)."-".substr($categoria[6],0,4)."</td>
				<td>".substr($categoria[5],11,8)."<br/>".substr($categoria[5],8,2)."-".substr($categoria[5],5,2)."-".substr($categoria[5],0,4)."</td>
				<td><a href='modificar.php?id=$categoria[0]&&nombre=$categoria[1]&&descripcion=$categoria[2]&&estado=$categoria[3]'><input type='image' width='15px' src='../imagenes/icons/edit.png'></a></td>
				<td><a href='alta.php?id=$categoria[0]&&nombre=$categoria[1]&&desc=$categoria[2]&&estado=$categoria[3]'><input type='image' width='15px' src='../imagenes/icons/ok.png'></a></td>
				<td><a href='baja.php?id=$categoria[0]&&nombre=$categoria[1]&&desc=$categoria[2]&&estado=$categoria[3]'><input type='image' width='15px' src='../imagenes/icons/remove.png'></a></td>
			</tr>";
}

}elseif (($_SESSION['rol'] == 3) OR ($_SESSION['rol'] == 2)){
