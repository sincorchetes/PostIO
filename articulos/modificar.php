...
tinymce.init({
	plugins: 'wordcount link autoresize',
    selector: 'textarea',
    width : 700,
	height : 250
 });
...
echo "<form action='alterar.php' method='post'>
			...
			<h1>Usted está editando el artículo $titulo</h1>
			<br/>
			<p>Título:</p><input type='text' value='$titulo' name='titulo'>
			<p>Texto:</p><textarea name='texto'>$texto</textarea>
			<p>Palabras clave:</p><input type='text' value='$palabra_clave' name='palabra_clave'>
			<p>Estado actual: $estado</p>
			<select name='estado'>
			<option value='Publicado'>Publicado</option>
			<option value='Borrador'>Borrador</option>
			<option value='Desactivado'>Desactivado</option>
			<option value='$estado'>$estado - <b>Valor actual</b></option>
			</select>
			<p>Autor: $autor</p>
